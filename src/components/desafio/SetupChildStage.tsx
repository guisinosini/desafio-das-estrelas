          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={clsx(
                ...
                newChild.gender === 'boy' ? "bg-primary/20 border-primary scale-105 shadow-lg" : "bg-white/5 border-white/10 hover:border-white/30"
              )}
            >
            ...
            <button
              ...
              className={clsx(
                "p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2",
                newChild.gender === 'girl' ? "bg-pink-500/20 border-pink-500 scale-105 shadow-lg" : "bg-white/5 border-white/10 hover:border-white/30"
              )}
            >
              <span className="text-3xl">👧</span>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-sm font-bold outline-none focus:border-primary transition-colors"
            />
          </div>
          <div className="space-y-4">
