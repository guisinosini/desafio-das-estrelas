      ...
      contentHtml = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background-color: #051210; color: #ffffff; border-radius: 24px;">
          ...
          <div style="text-align: center; margin-top: 40px;">
            <a href="https://kamaleon-clinic-hub.vercel.app/" style="background-color: #2dd4bf; color: #000000; padding: 16px 32px; border-radius: 12px; text-decoration: none; font-weight: bold;">Conhecer o Instituto</a>
          </div>
        </div>
      `;
    } else if (isRodaVida) {
